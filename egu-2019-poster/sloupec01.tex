...
%       \begin{split}
    ...
    {\bf Parameters $X$, $Y$, and $b$ were inferred for each soil textural class}. Variability of those parameters within and among textural classes is assessed in this poster. 
\end{block}



\subsection{Actual parameter values}
\begin{block}{Actual parameter values}
\begin{columns}
    \begin{column}{0.25\textwidth}
        Actual paramter values were inferred based on @@@PETR
    \end{column}
