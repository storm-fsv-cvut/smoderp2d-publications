...
%       \begin{split}
    ...
    \begin{equation}
      ...
      \label{eq:Phillips}
    \end{equation}
    {\bf Saturated hydraulic conductivity $Ks$ [$m/s$] and sorptivity $S$ [$m/\sqrt t $] were fitted with measured data.}
\end{block}
...
\begin{columns}
    \begin{column}{0.25\textwidth}
        Actual paramter values were inferred based on @@@(petr s referenci)
    \end{column}
