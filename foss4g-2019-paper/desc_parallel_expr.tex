...
CPU-parallelization may also bring good improvement in the computation
time reduction. The computation domain is separated into sub-domain
...
based on stream network. The sub-basins communicated with co called
ghost sell with each other where the water flowed between
sub-basins. The strategy aimed to generate as less ghost cells as
possible~\cite{Vivoni2011}.
