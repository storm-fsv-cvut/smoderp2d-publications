...
functionality related code from the~generic workflow defined by the base
...
easily extended to support other GIS packages responsible for the
...
assumed that the data preparation phase has been already performed by one
...
upcoming GRASS GIS version 7.8.  GRASS v.to.points module
